...
<body>
        ...
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            @if (Route::has('login'))
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right">
                    @auth
                        <a href="{{ url('/dashboard') }}" class="btn btn-full scrollto">Dashboard</a>
                    @else
                        <a href="{{ route('login') }}" class="btn btn-full scrollto">Log in</a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="btn btn-full scrollto">Register</a>
                        @endif
                    @endauth
                </div>
            @endif
        {{-- <a class="btn btn-full scrollto" href="#about">Register</a>
        <a class="btn btn-full scrollto" href="#about">Login</a> --}}
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <div id="logo" class="me-auto">
        <a href="index.html"><img src="LP/assets/img/logo-nav.png" alt=""></a>
  ...
  <main id="main">
    ...
    <section class="welcome text-center">
      ...
      <img alt="Bell - A perfect theme" class="gadgets-img hidden-md-down" src="LP/assets/img/gadgets.png">
    ...
    <section class="portfolio" id="portfolio">
      ...
      <div class="portfolio-grid">
        <div class="row">
          <div class="col-lg-3 col-sm-6 col-xs-12">
            <div class="card card-block">
              <a href="LP/assets/img/porf-1.jpg" class="portfolio-lightbox" data-gallery="portfolioGallery"><img alt="" src="LP/assets/img/porf-1.jpg">
          ...
          <div class="col-lg-3 col-sm-6 col-xs-12">
            <div class="card card-block">
              <a href="LP/assets/img/porf-2.jpg" class="portfolio-lightbox" data-gallery="portfolioGallery"><img alt="" src="LP/assets/img/porf-2.jpg">
                <div class="portfolio-over">
                  <div>
                    <h3 class="card-title">
                      The Dude Rockin'
          ...
          <div class="col-lg-3 col-sm-6 col-xs-12">
            <div class="card card-block">
              <a href="LP/assets/img/porf-3.jpg" class="portfolio-lightbox" data-gallery="portfolioGallery"><img alt="" src="LP/assets/img/porf-3.jpg">
                <div class="portfolio-over">
                  <div>
                    <h3 class="card-title">
                      The Dude Rockin'
          ...
          <div class="col-lg-3 col-sm-6 col-xs-12">
            <div class="card card-block">
              <a href="LP/assets/img/porf-4.jpg" class="portfolio-lightbox" data-gallery="portfolioGallery"><img alt="" src="LP/assets/img/porf-4.jpg">
                <div class="portfolio-over">
                  <div>
                    <h3 class="card-title">
                      The Dude Rockin'
        ...
        <div class="row">
          <div class="col-lg-3 col-sm-6 col-xs-12">
            <div class="card card-block">
              <a href="LP/assets/img/porf-5.jpg" class="portfolio-lightbox" data-gallery="portfolioGallery"><img alt="" src="LP/assets/img/porf-5.jpg">
                <div class="portfolio-over">
                  <div>
                    <h3 class="card-title">
                      The Dude Rockin'
          ...
          <div class="col-lg-3 col-sm-6 col-xs-12">
            <div class="card card-block">
              <a href="LP/assets/img/porf-6.jpg" class="portfolio-lightbox" data-gallery="portfolioGallery"><img alt="" src="LP/assets/img/porf-6.jpg">
                <div class="portfolio-over">
                  <div>
                    <h3 class="card-title">
                      The Dude Rockin'
          ...
          <div class="col-lg-3 col-sm-6 col-xs-12">
            <div class="card card-block">
              <a href="LP/assets/img/porf-7.jpg" class="portfolio-lightbox" data-gallery="portfolioGallery"><img alt="" src="LP/assets/img/porf-7.jpg">
                <div class="portfolio-over">
                  <div>
                    <h3 class="card-title">
                      The Dude Rockin'
          ...
          <div class="col-lg-3 col-sm-6 col-xs-12">
            <div class="card card-block">
              <a href="LP/assets/img/porf-8.jpg" class="portfolio-lightbox" data-gallery="portfolioGallery"><img alt="" src="LP/assets/img/porf-8.jpg">
                <div class="portfolio-over">
                  <div>
                    <h3 class="card-title">
                      The Dude Rockin'
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-3 col-xs-6">
            <div class="card card-block">
              <a href="#"><img alt="" class="team-img" src="LP/assets/img/team-1.jpg">
          ...
          <div class="col-sm-3 col-xs-6">
            <div class="card card-block">
              <a href="#"><img alt="" class="team-img" src="LP/assets/img/team-2.jpg">
                <div class="card-title-wrap">
                  <span class="card-title">Sergio Fez</span> <span class="card-text">Art Director</span>
                </div>
          ...
          <div class="col-sm-3 col-xs-6">
            <div class="card card-block">
              <a href="#"><img alt="" class="team-img" src="LP/assets/img/team-3.jpg">
                <div class="card-title-wrap">
                  <span class="card-title">Sergio Fez</span> <span class="card-text">Art Director</span>
                </div>
          ...
          <div class="col-sm-3 col-xs-6">
            <div class="card card-block">
              <a href="#"><img alt="" class="team-img" src="LP/assets/img/team-4.jpg">
                <div class="card-title-wrap">
                  <span class="card-title">Sergio Fez</span> <span class="card-text">Art Director</span>
                </div>
  ...
  <!-- Vendor JS Files -->
  <script src="LP/assets/vendor/purecounter/purecounter_vanilla.js"></script>
