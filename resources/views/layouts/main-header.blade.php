 ...
 header start-->
        <nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            ...
            <div class="text-left navbar-brand-wrapper">
                <a class="navbar-brand brand-logo" href="assets/index.html"><img src="assets/images/logo-dark.png" alt=""></a>
                <a class="navbar-brand brand-logo-mini" href="assets/index.html"><img src="assets/images/logo-icon-dark.png"
                        alt=""></a>
            </div>
            <!-- Top bar left -->
            ...
            <ul class="nav navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown ">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-big dropdown-notifications">
                        ...
                        <a href="{{ url('Details') }}/{{ $notification->data['id'] }}" >{{ $notification->data['title'] }} {{ $notification->data['user'] }} <small
                                >{{ $notification->created_at }}</small> </a>
                         </div>
                         <br>
                       @endforeach
                </li>
